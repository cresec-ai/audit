 ...
 */
export function hostAliasToolName(host: string, tool: string): string | undefined {
  if (host.length > POLICY_ALIAS_HOST_MAX_LEN || !POLICY_ALIAS_HOST_RE.test(host)) return undefined;
