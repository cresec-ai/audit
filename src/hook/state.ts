 ...
 */
export function claimSessionStart(dataDir: string, sessionId: string): boolean {
...
export function markPending(dataDir: string, requestId: string, t0Ms: number): void {
 ...
 */
export function takePending(dataDir: string, requestId: string): number | undefined {
