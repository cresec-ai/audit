...
export declare const LIMITS: {
     ...
     * therefore denied.
     */
    readonly any_arg_max_leaves: {
        readonly min: 16;
        readonly max: 65536;
    };
    readonly any_arg_max_bytes: {
        readonly min: 4096;
        readonly max: number;
    };
};
 ...
 */
export declare const ANY_ARG_MAX_LEAVES = 256;
/** `match.any_arg` DEFAULT budget: the most total UTF-8 bytes of leaf text scanned per call. */
export declare const ANY_ARG_MAX_BYTES: number;
