 ...
 */
export function noProxyMatches(noProxy, hostname, port) {
...
class ProxyTunnelAgent extends Agent {
    ...
    createConnection(options, callback) {
        ...
        const headers = { host: `${host}:${String(port)}` };
...
export function agentFor(target, env, connectTimeoutMs = CONNECT_TIMEOUT_MS) {
 ...
 */
export async function sinkFetch(req, env = process.env) {
