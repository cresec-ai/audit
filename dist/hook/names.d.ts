 ...
 */
export declare const POLICY_ALIAS_HOST_RE: RegExp;
export declare const POLICY_ALIAS_HOST_MAX_LEN = 253;
/**
 ...
 */
export declare function hostAliasToolName(host: string, tool: string): string | undefined;
